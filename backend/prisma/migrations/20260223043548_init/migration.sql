...
-- CreateIndex
CREATE INDEX "Blog_isPublished_createdAt_idx" ON "Blog"("isPublished", "createdAt" DESC);
...
-- CreateIndex
CREATE INDEX "Comment_blogId_createdAt_idx" ON "Comment"("blogId", "createdAt" DESC);
